...
* Created a lambda_handler function to save the file in json in format and upload it to the bucket
...
![Screenshot 2023-05-17 at 1 18 35 PM](https://github.com/amitshuklasigmoid/aws-assignment/assets/122515454/8bc934b8-a96d-4333-89d3-96a2f99e5e3b)


## Task 3
* Modify lambda function to accept parameters and return file name Modified lambda function 
* Create a POST API from API Gateway, pass parameters as request body to Lambda job. Return filename and status code as response.
* Consume API from local machine and pass unique data to lambda.
* Check if cloud watch logs are generated
